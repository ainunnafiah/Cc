...
<footer>
			...
			<div class="row">
				...
				<div class="col-md-12 text-center">
					<div class="social-bar">
						...
						?>
						<!-- <a target="_BLANK" href="https://www.facebook.com/profile.php?id=100079270325409" class="social-icon"><i class="fa fa-facebook" aria-hidden="true"></i></a> -->
						<a target="_BLANK" href="https://x.com/Code_crafters2?t=zzXh_iSmZFpiALLfzi3gTw&s=09" class="social-icon"><i class="fa fa-twitter" aria-hidden="true"></i></a>
						<a target="_BLANK" href="https://www.instagram.com/code_crafters_41" class="social-icon"><i class="fa fa-instagram" aria-hidden="true"></i></a>
						<a target="_BLANK" href="https://youtube.com/@codecraft" class="social-icon"><i class="fa fa-youtube" aria-hidden="true"></i></a>
					</div>
	...
	<div id="footer-bottom" class="py-4 text-center">
		<div class="container">
			<p>&copy; <?php echo date('Y'); ?> Copyright <b><?php echo $id_website['nama_website']; ?></b></p>
		</div>
	</div>
</footer>
