...
<div class="card" style="min-height:450px">
    ...
    <div class="card-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-4">
                <select name="section_berita[kategori]" class="form-control">
                    ...
                    ?>
                            <option value="<?php echo $kategori['id']; ?>" <?php echo ($get_section_berita['kategori'] ==  $kategori['id']) ? 'selected="selected"' : ''; ?>>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-4">
                <select name="section_berita[jumlah]" class="form-control">
                    ...
                    for ($n = 1; $n <= 10; $n++) {
                    ?>
                        <option value="<?php echo $n; ?>" <?php echo ($get_section_berita['jumlah'] == $n) ? 'selected="selected"' : ''; ?>>
                            <?php echo $n; ?>
                        </option>
                    <?php
                    }
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-4">
                <input placeholder="Selengkapnya" type="text" class="form-control" name="section_berita[label_link]" value="<?php echo $get_section_berita['label_link']; ?>">
            </div>
        </div>
    </div>
...
<div class="callout callout-info">
    <h5>Info</h5>
    <ul>
        <li>Isikan Judul / Deskripsi artikel.</li>
        <li>Pilih kategori artikel yang akan ditampilkan</li>
        <li>Batasi artikel yang ditampilkan dengan mengisi "Jumlah Berita Yang Tampil".</li>
        <li>Pilih "Layout" yang sesuai.</li>
        <li>"Label Link" untuk memberi nama link tautan ke halaman artikel (default:"selengkapnya").</li>
    </ul>
</div>