...
<a href="<?php echo base_url() . $this->uri->segment(1); ?>" class="brand-link navbar-light">
  <img src="<?php echo base_url(); ?>/asset/logo/logohimatif.png" alt="Admin Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
  <span class="brand-text font-weight-light" style='color:#000'>ADMIN CC</span>
</a>
    ...
    <ul class="nav nav-pills nav-sidebar flex-column nav-flat menu-open nav-legacy nav-compact" data-widget="treeview" role="menu" data-accordion="false">
      ...
      <li class="nav-item has-treeview">
        <a href="#" class="nav-link">
          ...
          <p>Modul Berita <i class="right fas fa-angle-left"></i></p>
        </a>
        <ul class="nav nav-treeview">
          <?php
